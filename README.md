# Ruby 3.1, 3.2 or 3.3 with Node.js 18 LTS or Node.js 20 LTS Dockerfile
...
A minimal Dockerfile based on Ruby (3.1, 3.2 or 3.3) Dockerfile (regular, slim or alpine) with Node.js 18 LTS (Hydrogen) or Node.js 20 LTS (Iron) installed.
