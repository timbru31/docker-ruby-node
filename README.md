# Ruby 3.0, 3.1 or 3.2 with Node.js 16 or 18 LTS Dockerfile
...
A minimal Dockerfile based on Ruby (3.0, 3.1, 3.2) Dockerfile (regular, slim or alpine) with Node.js 16 LTS (Gallium) or Node.js 18 LTS (Hydrogen) installed.
