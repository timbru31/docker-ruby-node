# Ruby 3.3, 3.4, 4.0 with Node.js 22 LTS, Node.js 24 LTS or Node.js 26 Dockerfile
...
A minimal Dockerfile based on Ruby (3.3, 3.4 or 4.0) Dockerfile (regular, slim or alpine) with Node.js 22 LTS (Jod), Node.js 24 LTS (Krypton) or Node.js 26 (Lithium) installed.
