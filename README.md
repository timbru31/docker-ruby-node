# Ruby 2.7, 3.0, 3.1 or 3.2 with Node.js 14, 16 or 18 LTS Dockerfile
...
A minimal Dockerfile based on Ruby (2.7, 3.0, 3.1, 3.2) Dockerfile (regular, slim or alpine) with Node.js 14 LTS (Fermium), Node.js 16 LTS (Gallium), Node.js 18 LTS (Hydrogen) installed.

## What's included

- Ruby 2.7, 3.0, 3.1, 3.2
- Node.js 14 LTS (Fermium), 16 LTS (Gallium), Node.js 18 LTS (Hydrogen)
